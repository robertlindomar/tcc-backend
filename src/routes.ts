...
import { RotasCategoria } from "./modules/categoria/rotas/categoria.rotas";
import { RotasConsumidor } from "./modules/consumidor/rotas/consumidor.rotas";
import { RotasDashboard } from "./modules/dashboard/rotas/dashboard.rotas";
...
import { RotasNfce } from "./modules/nfce/rotas/nfce.rotas";
...
export function routes() {
    ...
    router.use("/categoria", RotasCategoria());
